...
public class YesNoPopup extends Popup {
	...
	public void render(int mouseX, int mouseY, GuiScreen renderIn) {
		...
		if (this.isDisplayed()) {
			...
			this.confirmButton.xPosition = (renderIn.width / 2) - this.confirmButton.width - 20;
			this.confirmButton.yPosition = ((renderIn.height / 2) + (height / 2)) - this.confirmButton.height - 5;
			
			this.cancelButton.xPosition = (renderIn.width / 2) + 20;
			this.cancelButton.yPosition = ((renderIn.height / 2) + (height / 2)) - this.cancelButton.height - 5;
