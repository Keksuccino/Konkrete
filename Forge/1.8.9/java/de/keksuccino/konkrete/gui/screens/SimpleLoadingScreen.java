...
public class SimpleLoadingScreen extends GuiScreen {
	...
	public void drawScreen(int p_render_1_, int p_render_2_, float p_render_3_) {
		...
		drawRect(0, 0, this.width, this.height, Color.WHITE.getRGB());
	...
	public void drawStatus(String text, int width, int height) {
		mc.fontRendererObj.drawString(text, (float) (width - Minecraft.getMinecraft().fontRendererObj.getStringWidth(text) / 2), (float) height, 14821431, false);
	}
