		...
		if (this.opened) {
			...
			for (AdvancedButton b : this.content) {
				...
				if (this.parent != null) {
					...
					if ((this.x + this.getScaledWidth()) > Minecraft.getMinecraft().currentScreen.width) {
					...
					if (this.up) {
						b.yPosition = this.y + stackedHeight - this.lastHeight + this.getScaledButtonHeight() + this.space;
					} else {
						b.yPosition = this.y + stackedHeight;
					}
				} else {
					if (this.left) {
						b.xPosition = this.x - this.getScaledWidth();
					} else {
						b.xPosition = this.x;
					}
					
					if (this.up) {
						b.yPosition = this.y + stackedHeight - this.lastHeight;
					} else {
						b.yPosition = this.y + stackedHeight;
					}
				}
