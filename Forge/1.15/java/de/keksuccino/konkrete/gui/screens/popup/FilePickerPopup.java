...
public class FilePickerPopup extends Popup {
	...
	public void render(int mouseX, int mouseY, Screen renderIn) {
		...
		if (this.filetypesString != null) {
			drawCenteredString(Minecraft.getInstance().fontRenderer, Locals.localize("popup.choosefile.supported") + " " + this.filetypesString, renderIn.width / 2, renderIn.height - 50, Color.WHITE.getRGB());
