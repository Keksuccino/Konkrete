...
public class ConfigScreen extends Screen {
	...
	protected static class CategoryConfigScrollAreaEntry extends ScrollAreaEntry {
		...
		public void renderEntry(GuiGraphics graphics) {
			...
			if (this.displayName != null) {
				int nameWidth = font.width(this.displayName);
				graphics.drawString(font, this.displayName, center - (nameWidth / 2) , this.y + 10, Color.WHITE.getRGB());
			} else {
				int nameWidth = font.width(this.category);
				graphics.drawString(font, this.category, center - (nameWidth / 2) , this.y + 10, Color.WHITE.getRGB());
			}
