...
public class ExternalTextureAnimationRenderer implements IAnimationRenderer {
	...
	/**
	 * Needs to be called before calling {@link ExternalTextureAnimationRenderer#render()} and after minecraft's {@link TextureManager} instance was loaded.
	 */
	@Override
	...
	private void renderFrame() {
		...
		Minecraft.getMinecraft().getTextureManager().bindTexture(r.getResourceLocation());
