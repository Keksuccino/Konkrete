 ...
 */
import static de.keksuccino.konkrete.json.minidev.json.parser.ParseException.ERROR_UNEXPECTED_CHAR;
import static de.keksuccino.konkrete.json.minidev.json.parser.ParseException.ERROR_UNEXPECTED_EOF;
import static de.keksuccino.konkrete.json.minidev.json.parser.ParseException.ERROR_UNEXPECTED_LEADING_0;
import static de.keksuccino.konkrete.json.minidev.json.parser.ParseException.ERROR_UNEXPECTED_TOKEN;
import static de.keksuccino.konkrete.json.minidev.json.parser.ParseException.ERROR_UNEXPECTED_UNICODE;
