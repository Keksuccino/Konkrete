...
- Full reusable resource system: resource indexing/reload/preload, file types, text/audio/image/GIF/APNG/video handlers, ownership cleanup, and configurable safety limits.
...
- FMA and AFMA decoding, playback, creator tools, and UI: kept exclusive to FancyMenu.
