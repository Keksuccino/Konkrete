...
class SmoothRoundedBoxShaderTest {
    ...
    private static final String SHARED_COVERAGE_IMPORT = "#moj_import <konkrete:konkrete_rounded_box.glsl>";
    ...
    void rectangleShadersUseSharedSharpCornerCoverage() throws IOException {
        String sharedCoverage = readResource("/assets/konkrete/shaders/include/konkrete_rounded_box.glsl");
        String imageRectangleShader = readResource("/assets/konkrete/shaders/core/gui_smooth_image_rect.fsh");
        String rectangleShader = readResource("/assets/konkrete/shaders/core/gui_smooth_rect.fsh");
        String blurShader = readResource("/assets/konkrete/shaders/post/gui_blur.fsh");
        ...
        assertEquals(1, countOccurrences(imageRectangleShader, "konkreteRoundedBoxAlpha("));
        assertTrue(rectangleShader.contains(SHARED_COVERAGE_IMPORT));
        assertEquals(2, countOccurrences(rectangleShader, "konkreteRoundedBoxAlpha("));
        assertTrue(blurShader.contains(SHARED_COVERAGE_IMPORT));
        assertEquals(1, countOccurrences(blurShader, "konkreteRoundedBoxAlpha("));
    }
