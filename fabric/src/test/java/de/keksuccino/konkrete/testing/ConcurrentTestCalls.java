package de.keksuccino.konkrete.testing;
...
/** Coordinates deterministic simultaneous calls in concurrency regression tests. */
public final class ConcurrentTestCalls {

    private ConcurrentTestCalls() {
    }

    /** Invokes the supplier concurrently and returns results in submission order. */
    @NotNull
