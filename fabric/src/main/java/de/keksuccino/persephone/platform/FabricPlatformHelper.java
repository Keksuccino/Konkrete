package de.keksuccino.persephone.platform;

import com.mojang.blaze3d.platform.InputConstants;
import de.keksuccino.persephone.mixin.mixins.common.client.AccessorMixinKeyMapping;
import de.keksuccino.persephone.platform.services.IPlatformHelper;
...
public class FabricPlatformHelper implements IPlatformHelper {
    ...
    public InputConstants.Key getKeyMappingKey(KeyMapping keyMapping) {
        return ((AccessorMixinKeyMapping) keyMapping).get_key_Persephone();
    }
