float konkreteResolveCornerRadius(vec2 position, vec4 cornerRadii) {
...
float konkreteRoundedBoxDistance(vec2 position, vec2 halfSize, float cornerRadius) {
...
float konkreteSharpBoxAlpha(vec2 position, vec2 halfSize, vec2 coordinateDerivativeWidth) {
...
float konkreteRoundedBoxAlpha(vec2 position, vec2 halfSize, vec4 cornerRadii) {
    float cornerRadius = konkreteResolveCornerRadius(position, cornerRadii);
    float distance = konkreteRoundedBoxDistance(position, halfSize, cornerRadius);
    ...
    float sharpAlpha = konkreteSharpBoxAlpha(position, halfSize, coordinateDerivativeWidth);
