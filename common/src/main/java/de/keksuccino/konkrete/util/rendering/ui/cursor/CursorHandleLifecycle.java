...
final class CursorHandleLifecycle {
    ...
    private void shutdownOnGlfwThread(@NotNull List<Handle> customSnapshot, @NotNull List<Handle> standardSnapshot) {
        ...
        // Custom cursors are detached first; standard cursors remain a valid Konkrete fallback until this point.
    ...
    interface ThreadExecutor {
        ...
        /** Schedules work on the GLFW-owning thread. */
    ...
    interface NativeOperations {
        ...
        /** Prevents new native cursor work before GLFW teardown. */
        void prepareForShutdown();

        /** Destroys one GLFW cursor handle. */
