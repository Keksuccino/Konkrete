 ...
 * Keeping the API interface out of the static type graph lets Fabric compile and run Konkrete without WaterMedia.
 */
final class WatermediaVulkanContext implements InvocationHandler {
    ...
    WatermediaVulkanContext(VulkanDevice device) {
        ...
        try {
            Class<?> vkContextClass = Class.forName("org.watermedia.api.media.engines.vk.VKContext", false, WatermediaIntegrationConfig.getClassLoader());
    ...
    /** Implements the optional Watermedia VKContext contract without static linkage. */
    @Override
    public Object invoke(Object proxy, Method method, Object[] args) {
        return switch (method.getName()) {
            ...
            case "toString" -> "Konkrete Watermedia VKContext";
