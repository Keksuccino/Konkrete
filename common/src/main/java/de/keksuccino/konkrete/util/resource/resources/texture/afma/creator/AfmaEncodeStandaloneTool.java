 ...
 * Konkrete's creator UI or booting the full in-game export screen flow. It drives {@link AfmaEncodePlanner} and
 ...
 *     {@code de.keksuccino.konkrete.util.resource.resources.texture.afma} and
 *     {@code de.keksuccino.konkrete.util.resource.resources.texture.afma.creator}, plus shared utility classes
 ...
 *     <li>Use {@code --temp-dir <dir>} or the {@code konkrete.afma.temp_dir} system property to redirect AFMA temp files
 *     during isolated runs.</li>
 * </ul>
 *
 * <p>Example invocation after compiling:
 * <pre>{@code
 * java ... de.keksuccino.konkrete.util.resource.resources.texture.afma.creator.AfmaEncodeStandaloneTool \
 *   --main /path/to/frames \
...
public final class AfmaEncodeStandaloneTool {
    ...
    /** Builds the options for the AFMA creator. */
    @NotNull
    ...
    /** Applies the preset defaults to the AFMA creator. */
    ...
    /** Prints the configuration for the AFMA creator command. */
    ...
    /** Prints the plan summary for the AFMA creator command. */
    ...
    /** Prints the progress for the AFMA creator command. */
    ...
    /** Formats the sequence description for the AFMA creator command. */
    @NotNull
    ...
    /** Resolves the sequence for the AFMA creator. */
    @NotNull
    ...
    /** Normalizes the output file for the AFMA creator. */
    @NotNull
    ...
    /** Formats the bytes for AFMA creator diagnostics. */
    @NotNull
    ...
    /** Formats the duration for AFMA creator diagnostics. */
    @NotNull
    ...
    /** Configures {@code StandalonePreset} limits and tradeoffs for the AFMA creator. */
    ...
    /** Models {@code NaturalFilenameComparator} state used by the AFMA creator. */
    protected static final class NaturalFilenameComparator implements Comparator<String> {

        /** Shared stateless instance used by the AFMA creator. */
        ...
        /** Compares the compare values for the AFMA creator. */
        @Override
    ...
    /** Returns whether contains help flag. */
    ...
    /** Parses the key value args from the AFMA creator input. */
    @NotNull
    ...
    /** Requires the file before AFMA creator processing. */
    @NotNull
    ...
    /** Parses the int from the AFMA creator input. */
    ...
    /** Parses the long from the AFMA creator input. */
    ...
    /** Parses the double from the AFMA creator input. */
    ...
    /** Parses the boolean from the AFMA creator input. */
