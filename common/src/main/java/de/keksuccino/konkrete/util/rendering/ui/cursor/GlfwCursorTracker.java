...
public final class GlfwCursorTracker {
    ...
    /** Handles GLFW set cursor for this GLFW cursor tracker. */
    public static void onGlfwSetCursor(long window, long cursor) {
        ACTIVE_CURSOR_BY_WINDOW.put(window, cursor);
    }

    /** Handles GLFW create standard cursor for this GLFW cursor tracker. */
    ...
    /** Handles GLFW destroy window for this GLFW cursor tracker. */
    public static void onGlfwDestroyWindow(long window) {
        ACTIVE_CURSOR_BY_WINDOW.remove(window);
    }

    /** Handles GLFW destroy cursor for this GLFW cursor tracker. */
    ...
    /** Returns active cursor by window view. */
    @NotNull
