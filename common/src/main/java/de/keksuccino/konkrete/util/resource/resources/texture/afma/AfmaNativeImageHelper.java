...
/** Provides {@code AfmaNativeImageHelper} transformations and validation used by the AFMA codec. */
public final class AfmaNativeImageHelper {
    ...
    /** Extracts resource state from the AFMA codec data. */
    @NotNull
    ...
    /** Copies the rect for the AFMA codec. */
    ...
    /** Copies the pixels into the AFMA codec image. */
    ...
    /** Copies the interleaved bytes into the AFMA codec image. */
    ...
    /** Applies the residual bytes to the AFMA codec. */
    ...
    /** Applies the sparse residual bytes to the AFMA codec. */
    ...
    /** Applies the sparse residual payload unchecked to the AFMA codec. */
    ...
    /** Copies the rect memmove for the AFMA codec. */
    ...
    /** Copies the rects memmove for the AFMA codec. */
