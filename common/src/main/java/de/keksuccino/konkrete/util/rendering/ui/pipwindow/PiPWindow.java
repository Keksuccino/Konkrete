...
/** Hosts an independently scaled, movable, and resizable UI body above a screen. */
...
public class PiPWindow extends AbstractContainerEventHandler implements Renderable {
    ...
    private static final Identifier DEFAULT_CLOSE_BUTTON_ICON = Identifier.fromNamespaceAndPath("konkrete", "textures/pip/pip_window_close.png");
    private static final Identifier DEFAULT_MAXIMIZE_BUTTON_ICON = Identifier.fromNamespaceAndPath("konkrete", "textures/pip/pip_window_maximize.png");
    private static final Identifier DEFAULT_NORMALIZE_BUTTON_ICON = Identifier.fromNamespaceAndPath("konkrete", "textures/pip/pip_window_restore.png");
    ...
    private boolean forceKonkreteUiScaleEnabled = true;
    private double forcedKonkreteUiScale = 1.0;
    ...
    /** Initializes a dockable window from the supplied title, bounds, or backing screen. */
    ...
    /** Creates an empty pi p window with default state. */
    public PiPWindow() {
    ...
    /** Sets screen for this icon render data. */
    ...
    /** Sets title for this icon render data. */
    ...
    /** Sets icon for this icon render data. */
    ...
    /** Returns the rasterized Material icon texture or explicit window icon; may be {@code null}. */
    @Nullable
    ...
    /** Sets close button icon for this icon render data. */
    ...
    /** Sets maximize button icon for this icon render data. */
    ...
    /** Sets normalize button icon for this icon render data. */
    ...
    /** Sets visible for this icon render data. */
    ...
    /** Returns whether screen auto scaling enabled. */
    public boolean isScreenAutoScalingEnabled() {
        return this.screenAutoScalingEnabled;
    }

    /** Sets screen auto scaling enabled for this icon render data. */
    ...
    /** Returns custom body scale. */
    public @Nullable Double getCustomBodyScale() {
        return this.customBodyScale;
    }

    /** Sets custom body scale for this icon render data. */
    ...
    public boolean isForceKonkreteUiScale() {
        return this.forceKonkreteUiScaleEnabled;
    }

    /** Sets force UI scale for this icon render data. */
    public PiPWindow setForceKonkreteUiScale(boolean forceKonkreteUiScaleEnabled) {
        if (this.forceKonkreteUiScaleEnabled == forceKonkreteUiScaleEnabled) {
            return this;
        }
        this.forceKonkreteUiScaleEnabled = forceKonkreteUiScaleEnabled;
        if (this.forceKonkreteUiScaleEnabled) {
            updateForcedKonkreteUiScale();
        }
        resizeScreenIfNeeded();
        return this;
    }

    /** Returns whether always on top. */
    public boolean isAlwaysOnTop() {
        return this.alwaysOnTop;
    }

    /** Sets always on top for this icon render data. */
    ...
    /** Returns whether force focus enabled. */
    public boolean isForceFocusEnabled() {
        return this.forceFocusEnabled;
    }

    /** Sets force focus for this icon render data. */
    ...
    /** Returns whether title bar icon tint enabled. */
    public boolean isTitleBarIconTintEnabled() {
        return this.titleBarIconTintEnabled;
    }

    /** Sets title bar icon tint enabled for this icon render data. */
    ...
    /** Sets resizable for this icon render data. */
    ...
    /** Handles closed for this icon render data. */
    ...
    /** Sets position for this icon render data. */
     ...
     * using Konkrete's UI scale, and the body screen can still render at a different scale
     * (auto/custom/forced).
     * <p>
    ...
    /** Sets bounds for this close window decision impl. */
    ...
    /** Sets title bar height for this close window decision impl. */
    ...
    /** Sets border thickness for this close window decision impl. */
    ...
    /** Sets maximized for this close window decision impl. */
    ...
    /** Sets input locked for this close window decision impl. */
    public PiPWindow setInputLocked(boolean inputLocked) {
        this.inputLocked = inputLocked;
        return this;
    }

    /** Sets block minecraft screen inputs for this close window decision impl. */
    ...
    /** Returns whether input locked. */
    public boolean isInputLocked() {
        return this.inputLocked || this.inputLockedByChildren;
    }

    /** Returns whether blocking minecraft screen inputs. */
    ...
    private boolean isDockingEnabled() {
        return UIConfiguration.get().pipWindowDockingEnabled();
    }
    ...
    private double getScreenRenderScaleFactor() {
        if (this.forceKonkreteUiScaleEnabled) {
            updateForcedKonkreteUiScale();
            return this.forcedKonkreteUiScale;
        }
    ...
    private void updateForcedKonkreteUiScale() {
        double scale = UIBase.calculateFixedRenderScale(UIBase.getUIScale());
        if (!Double.isFinite(scale) || scale <= 0.0) {
            scale = 1.0;
        }
        this.forcedKonkreteUiScale = scale;
    }
    ...
    public boolean isDebug() {
        return UIConfiguration.get().pipWindowDebugEnabled();
    }
