...
/** Persists the file browser's video-preview volume in the configured data directory. */
public class BrowserVideoSettings {
    ...
    /** Resolves the video-preview settings file from the current UI data directory. */
    @NotNull
    public static File getSettingsFile() {
        return UIConfiguration.get().dataDirectory().resolve("browser_video_settings.json").toFile();
    }
    ...
    private static void read() {
        try {
            ...
            LOGGER.error("[KONKRETE] Failed to read browser video settings!", ex);
        }
    }
    ...
    private static void write() {
        try {
            ...
            LOGGER.error("[KONKRETE] Failed to write browser video settings!", ex);
        }
    }
