...
/** Provides {@code AfmaSparsePayloadHelper} transformations and validation used by the AFMA codec. */
public final class AfmaSparsePayloadHelper {

    /** Configured tile mask tile size used by the AFMA codec. */
    public static final int TILE_MASK_TILE_SIZE = 8;

    private AfmaSparsePayloadHelper() {
    }

    /** Builds the bitmask layout for the AFMA codec. */
    @NotNull
    ...
    /** Builds the coord list layout for the AFMA codec. */
    @NotNull
    ...
    /** Builds the row span layout for the AFMA codec. */
    @NotNull
    ...
    /** Builds the tile mask layout for the AFMA codec. */
    @NotNull
    ...
    /** Validates the layout before AFMA codec processing. */
    ...
    /** Iterates over the changed pixels in the AFMA codec data. */
    ...
    /** Iterates over the bitmask in the AFMA codec data. */
    ...
    /** Iterates over the coord list in the AFMA codec data. */
    ...
    /** Iterates over the row spans in the AFMA codec data. */
    ...
    /** Iterates over the tile mask in the AFMA codec data. */
    ...
    /** Consumes {@code ChangedPixelConsumer} values emitted by the AFMA codec. */
    @FunctionalInterface
    public interface ChangedPixelConsumer {
        /** Consumes one changed pixel mapping. */
