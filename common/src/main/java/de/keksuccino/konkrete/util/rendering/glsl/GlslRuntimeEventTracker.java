...
/**
 * Global input event tracker used by Konkrete GLSL renderers.
 *
...
public final class GlslRuntimeEventTracker {
    ...
    /** GLFW action code for a released key or mouse button. */
    public static final int KEY_ACTION_RELEASE = 0;
    /** GLFW action code for an initial key or mouse-button press. */
    public static final int KEY_ACTION_PRESS = 1;
    /** GLFW action code for a repeated key press. */
    public static final int KEY_ACTION_REPEAT = 2;

    /** Number of mouse buttons tracked by the shader input state. */
    ...
    /** Handles mouse moved for this GLSL runtime event tracker. */
    ...
    /** Handles mouse button pressed for this GLSL runtime event tracker. */
    ...
    /** Handles mouse button released for this GLSL runtime event tracker. */
    ...
    /** Handles mouse scrolled for this GLSL runtime event tracker. */
    ...
    /** Handles key pressed for this GLSL runtime event tracker. */
    ...
    /** Handles key released for this GLSL runtime event tracker. */
    ...
    /** Handles char typed for this GLSL runtime event tracker. */
    ...
    /** Captures an immutable snapshot of current pointer, keyboard, and character-input state. */
    @NotNull
    ...
    /** Captures input at one point in its lifecycle. */
