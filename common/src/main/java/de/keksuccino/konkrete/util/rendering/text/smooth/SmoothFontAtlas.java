...
final class SmoothFontAtlas implements AutoCloseable {
    ...
    private void resizeAtlas(int newWidth, int newHeight) {
        ...
        LOGGER.info("[KONKRETE] Resizing smooth font atlas '{}' ({}): {}x{} -> {}x{}", debugName, sizeLabel, logicalWidth, logicalHeight, targetWidth, targetHeight);
    ...
    private void replaceTexture() {
        ...
        DynamicTexture newTexture = new DynamicTexture(() -> "konkrete_smooth_font_" + debugName, resizedImage);
    ...
    private void ensureInitialized() {
        ...
        synchronized (this) {
            ...
            this.dynamicTexture = new DynamicTexture(() -> "konkrete_smooth_font_" + debugName, atlasImage);
            TextureManager textureManager = Minecraft.getInstance().getTextureManager();
            this.textureLocation = Identifier.fromNamespaceAndPath("konkrete", "smooth_font/" + debugName.toLowerCase().replaceAll("[^a-z0-9_./-]", "_"));
