...
public class ResourceSource {
    ...
    /** Current source type state for this resource runtime instance. */
    protected ResourceSourceType sourceType;
    /** Current resource source without prefix state for this resource runtime instance. */
    protected String resourceSourceWithoutPrefix;
    /** Current serialization source without prefix state for this resource runtime instance. */
    protected String serializationSourceWithoutPrefix;
    /** Whether is dot minecraft source currently applies to this resource runtime instance. */
    protected boolean isDotMinecraftSource = false;
    /** Current resolved local path state for this resource runtime instance. */
    @Nullable
    ...
    /** Initializes a new {@code ResourceSource} for resource runtime use. */
    ...
    /** Returns whether this local source was serialized relative to the default Minecraft directory. */
    public boolean isDotMinecraftSource() {
        return this.isDotMinecraftSource;
    }

    /** Converts the string from the resource runtime representation. */
    @Override
