...
public final class TextureManagerReleaseDispatcher {
     ...
     * immediately before this call, so no registered Konkrete texture entry can be created after the pending set drains.
     */
    ...
    private static final class PendingRelease implements Runnable {
        ...
        /** Runs resource state for the texture resource. */
        @Override
        public void run() {
