...
/** Fetches public Minecraft profile and texture metadata. */
public class MinecraftUsers {
    ...
    public static UserProfile getUserProfile(@NotNull String playerName) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                LOGGER.error("[KONKRETE] Failed to get player profile via Mojang API: " + playerName + " (HTTP " + responseCode + ")");
            }

        } catch (Exception ex) {
            LOGGER.error("[KONKRETE] Failed to get player profile via Mojang API: " + playerName, ex);
        } finally {
            if (connection != null) {
    ...
    public static MinecraftProfileTextures getProfileTextures(@NotNull String playerName) {
        ...
        try {
            ...
            CACHED_PROFILE_TEXTURES.put(playerName, MISSING_PROFILE_TEXTURES);
            LOGGER.error("[KONKRETE] Failed to get player skin!", ex);
        }
