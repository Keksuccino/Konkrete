...
import de.keksuccino.konkrete.util.rendering.GuiScissorUtil;
...
/** Renders smooth text into Minecraft's deferred GUI pipeline. */
public final class SmoothTextRenderer {
    ...
    private static boolean isMultilineEnabled() {
        return UIConfiguration.get().smoothFontMultilineEnabled();
    }
    ...
    /** Renders text screen space into the active GUI extraction pass. */
    ...
    private static int applyFormatting(String text, int formatIndex, StyleState style, int baseColor) {
        ...
        Integer color = getFormattingColor_Konkrete(formatting);
        if (color != null) {
    ...
    @Nullable
    private static Integer getFormattingColor_Konkrete(@Nonnull ChatFormatting formatting) {
    ...
    private static final class ComponentRenderState implements FormattedCharSink {
        ...
        /** Consumes the supplied callback value. */
        @Override
    ...
    private static final class MeasureCache<K> extends LinkedHashMap<K, TextDimensions> {
        ...
        /** Removes eldest entry from this measure cache. */
        @Override
    ...
    private static final class LegacyMeasureKey {
        ...
        /** Returns a hash code consistent with equality. */
        @Override
        public int hashCode() {
