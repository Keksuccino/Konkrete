...
/** Updates and renders the confetti visual effect. */
public class ConfettiOverlay extends AbstractWidget implements NavigatableWidget {
    ...
    /** Sizes the confetti effect to the supplied GUI region. */
    public ConfettiOverlay(int width, int height) {
        super(0, 0, width, height, Component.empty());
    }

    /** Sets scale for this confetti overlay. */
    ...
    /** Sets fall speed multiplier for this confetti overlay. */
    ...
    /** Sets base color for this confetti overlay. */
    ...
    /** Spawns a confetti burst centered on the supplied GUI position. */
    ...
    /** Adds collision area to this confetti overlay. */
    ...
    /** Removes all registered collision areas. */
    public void clearCollisionAreas() {
        this.collisionAreas.clear();
    }

    /** Rebuilds collision areas from the current UI state. */
    ...
    /** Sets focusable for this confetti overlay. */
    @Override
    ...
    /** Sets navigatable for this confetti overlay. */
    @Override
    ...
    private enum ConfettiSide {
        ...
        TOP,
        /** Positions the element at bottom. */
        BOTTOM;
