...
/** Renders minecraft logo into Minecraft's deferred GUI pipeline. */
public class MinecraftLogoRenderer {
    ...
    /** Configures whether the Minecraft logo remains visible through screen fades. */
