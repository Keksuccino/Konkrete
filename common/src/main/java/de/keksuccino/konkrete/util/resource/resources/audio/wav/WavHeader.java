...
/** Stores validated WAV format metadata required to upload PCM data to OpenAL. */
public class WavHeader {
    ...
    /** Reads resource data from the audio resource input. */
    public static WavHeader read(InputStream inputStream) throws IOException {
        ...
        while (inputStream.read(chunkHeader) == 8) {
            ...
            if (skipped != chunkSize) {
                LOGGER.warn("[KONKRETE] WAV Header - Failed to skip full chunk data");
                break;
            }
        ...
        if (!foundData) {
            LOGGER.warn("[KONKRETE] WAV Header - No data chunk found");
        }
    ...
    /** Returns the duration in seconds used by this audio resource instance. */
    public float getDurationInSeconds() {
        if (sampleRate <= 0 || channels <= 0 || bitsPerSample <= 0 || dataSize <= 0) {
            LOGGER.warn("[KONKRETE] WAV Header - Invalid values for duration calculation:");
    ...
    /** Returns the data size used by this audio resource instance. */
    public int getDataSize() {
        return dataSize;
    }

    /** Returns the sample rate used by this audio resource instance. */
    public int getSampleRate() {
        return sampleRate;
    }

    /** Returns the bits per sample used by this audio resource instance. */
    public int getBitsPerSample() {
        return bitsPerSample;
    }

    /** Returns the channels used by this audio resource instance. */
