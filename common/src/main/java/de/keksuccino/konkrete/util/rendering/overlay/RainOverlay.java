...
/** Updates and renders the rain visual effect. */
public class RainOverlay extends AbstractWidget implements NavigatableWidget {
    ...
    /** Sizes the rain effect to the supplied GUI region. */
    public RainOverlay(int width, int height) {
        super(0, 0, width, height, Component.empty());
    }

    /** Sets intensity for this rain overlay. */
    ...
    /** Sets scale for this rain overlay. */
    ...
    /** Sets color for this rain overlay. */
    ...
    /** Sets thunder enabled for this rain overlay. */
    ...
    /** Sets thunder brightness for this rain overlay. */
    ...
    /** Adds collision area to this rain overlay. */
    ...
    /** Sets puddles enabled for this rain overlay. */
    ...
    /** Sets drips enabled for this rain overlay. */
    ...
    /** Sets focusable for this rain overlay. */
    @Override
    ...
    /** Sets navigatable for this rain overlay. */
    @Override
