package de.keksuccino.konkrete.util.rendering.text;
...
/** Converts chat components between Minecraft's structured JSON and component forms. */
public class ComponentParser {

    private static final Logger LOGGER = LogManager.getLogger();

    /** Parses structured component JSON, falling back to a literal component for plain text. */
    ...
    public static String toJson(@NotNull Component component, @Nullable HolderLookup.Provider registries) {
        try {
            ...
            if (registries != null) {
                return de.keksuccino.konkrete.util.rendering.ui.widget.component.ComponentSerialization.Serializer.toJson(serializableComponent, registries);
            }
            ...
            LOGGER.info("[KONKRETE] Failed to serialize Component to JSON. Falling back to plain text.", ex);
