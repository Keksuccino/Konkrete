...
/** Implements the interactive window body for color picker. */
public class ColorPickerWindowBody extends PiPWindowBody {
    ...
    /** Initializes a color picker with a preset and update, completion, and cancellation callbacks. */
    public ColorPickerWindowBody(@Nullable DrawableColor presetColor, @NotNull Consumer<DrawableColor> onColorUpdate, @NotNull Consumer<DrawableColor> onDone, @NotNull Consumer<DrawableColor> onCancel) {
        super(Component.translatable("konkrete.ui.color_picker.title"));
    ...
    /** Initializes resources required by this color picker window body. */
    @Override
    protected void init() {
        this.cancelButton = new ExtendedButton(0, 0, 100, 20, Component.translatable("konkrete.common_components.cancel"), (button) -> {
        ...
        this.doneButton = new ExtendedButton(0, 0, 100, 20, Component.translatable("konkrete.common_components.done"), (button) -> {
    ...
    /** Handles window closed externally for this color picker window body. */
    @Override
    ...
    private void renderLeftPanel(@NotNull GuiGraphicsExtractor graphics, @NotNull UITheme theme) {
        ...
        UIBase.renderText(graphics, Component.translatable("konkrete.ui.color_picker.hue"), this.hueX, this.hueLabelY);
        this.renderHueSlider(graphics, theme);

        UIBase.renderText(graphics, Component.translatable("konkrete.ui.color_picker.alpha"), this.alphaX, this.alphaLabelY);
    ...
    private void renderInfoPanel(@NotNull GuiGraphicsExtractor graphics, @NotNull UITheme theme) {
        ...
        UIBase.renderText(graphics, Component.translatable("konkrete.ui.color_picker.preview"), x, previewLabelY);
        ...
        if (this.presetColor != null) {
            ...
            UIBase.renderText(graphics, Component.translatable("konkrete.ui.color_picker.original"), presetX, previewLabelY);
        ...
        UIBase.renderText(graphics, Component.translatable("konkrete.ui.color_picker.hex"), x, y);
        y += labelHeight + 2;
        UIBase.renderText(graphics, Component.literal(this.getCurrentHex()), x, y, theme.ui_interface_generic_text_color.getColorInt());

        y += labelHeight + 8;
        UIBase.renderText(graphics, Component.translatable("konkrete.ui.color_picker.rgba"), x, y);
        y += labelHeight + 2;
        ...
        y += labelHeight + 8;
        UIBase.renderText(graphics, Component.translatable("konkrete.ui.color_picker.hsv"), x, y);
        y += labelHeight + 2;
