package de.keksuccino.konkrete.util.media;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.google.gson.JsonSyntaxException;
import com.google.gson.annotations.SerializedName;
import de.keksuccino.konkrete.util.terminal.CommandResult;
import de.keksuccino.konkrete.util.terminal.PowerShellUtils;
import java.io.*;
...
public final class GsmtcNowPlaying {
    ...
    public static final class MediaInfo {
        ...
        /** Returns whether playback status is the Windows playing state. */
        public boolean isPlaying() {
            return Boolean.TRUE.equals(playing);
        }

        /** Returns the position seconds. */
        ...
        /** Returns the last updated instant. */
    ...
    private static class PersistentPowerShell {
        ...
        /** Script output marker indicating the persistent process is ready. */
        public static final String READY_MARKER = "__READY__";
        /** Script output marker terminating one response envelope. */
        public static final String END_MARKER = "__END__";

        /** Current persistent PowerShell child process. */
        public Process process;
        /** Command stream connected to the child process. */
        public BufferedWriter writer;
        /** Output stream connected to the child process. */
        public BufferedReader reader;

        /** Sends one query and blocks until its delimited JSON response is read. */
        ...
        /** Discards the persistent process so a later query starts a fresh host. */
        public synchronized void invalidate() {
            close();
        }

        /** Requests process exit, waits for termination, and closes all streams idempotently. */
        ...
        /** Starts and initializes the persistent host when no live process exists. */
        ...
        /** Starts a UTF-8 PowerShell host and initializes the query module. */
        ...
        /** Loads the embedded query module and waits for its readiness marker. */
        ...
        /** Stores a media snapshot and its update timestamp. */
