...
/** Updates and renders the snowfall visual effect. */
public class SnowfallOverlay extends AbstractWidget implements NavigatableWidget {
    ...
    /** Sizes the snowfall effect to the supplied GUI region. */
    public SnowfallOverlay(int width, int height) {
        super(0, 0, width, height, Component.empty());
    }

    /** Sets intensity for this snowfall overlay. */
    ...
    /** Sets scale for this snowfall overlay. */
    ...
    /** Sets fall speed multiplier for this snowfall overlay. */
    ...
    /** Sets color for this snowfall overlay. */
    ...
    /** Adds collision area to this snowfall overlay. */
    ...
    /** Sets accumulation enabled for this snowfall overlay. */
    ...
    /** Sets focusable for this snowfall overlay. */
    @Override
    ...
    /** Sets navigatable for this snowfall overlay. */
    @Override
