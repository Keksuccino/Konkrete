...
/** Base implementation for UI component. */
public abstract class UIComponent extends UIBase implements FocuslessContainerEventHandler, Renderable, NarratableEntry {

    /** Z offset applied to this component and its children. */
    public float posZ = 0f;
    /** Whether the pointer currently hovers this element. */
    protected boolean hovered = false;
    /** Whether this component participates in rendering and input. */
    protected boolean visible = true;
    /** Client instance providing rendering and input services. */
    protected Minecraft mc = Minecraft.getInstance();
    /** Whether this component is handling a pointer drag. */
    ...
    /** Sets visible for this UI component. */
    ...
    /** Sets dragging for this UI component. */
    @Override
    ...
    /** Sets focused for this UI component. */
    @Override
