...
public class DrawableColor {
    ...
    /** Java color backing the cached encodings. */
    protected Color color;
    /** Packed ARGB encoding of {@link #color}. */
    protected int colorInt;
    /** Canonical hexadecimal representation of the current channels. */
    protected String hex;
    /** Lazily cached normalized channel values. */
    protected FloatColor floatColor;

    /** Wraps a packed color value while preserving the supplied integer for rendering. */
    @NotNull
    ...
    /** Copies the channels of an AWT color into render-ready representations. */
    @NotNull
    ...
    /** Parses {@code #RRGGBB} or {@code #RRGGBBAA}; malformed values return {@link #EMPTY}. */
    @NotNull
    ...
    /** Parses CSS-style short or long hexadecimal colors and basic HTML color names. */
    @NotNull
    ...
    /** Creates an opaque color from integer red, green, and blue channels. */
    @NotNull
    public static DrawableColor of(int r, int g, int b) {
        return of(r, g, b, 255);
    }

    /** Creates a color from integer red, green, blue, and alpha channels. */
    @NotNull
    ...
    /** Creates an empty drawable color with default state. */
    protected DrawableColor() {
    }

    /** Applies these RGB channels and the supplied alpha to GUI extraction state. */
    public void setAsShaderColor(@NotNull GuiGraphicsExtractor graphics, float alpha) {
        FloatColor c = this.getAsFloats();
        de.keksuccino.konkrete.util.rendering.RenderingUtils.setShaderColor(graphics, c.red(), c.green(), c.blue(), alpha);
    }

    /** Applies all four channels to GUI extraction state. */
    public void setAsShaderColor(@NotNull GuiGraphicsExtractor graphics) {
        FloatColor c = this.getAsFloats();
        de.keksuccino.konkrete.util.rendering.RenderingUtils.setShaderColor(graphics, c.red(), c.green(), c.blue(), c.alpha());
    }

    /** Restores the GUI extraction tint to opaque white. */
    public void resetShaderColor(@NotNull GuiGraphicsExtractor graphics) {
        de.keksuccino.konkrete.util.rendering.RenderingUtils.setShaderColor(graphics, 1.0F, 1.0F, 1.0F, 1.0F);
    }

    /** Returns lazily cached normalized red, green, blue, and alpha channels. */
    @NotNull
    ...
    /** Returns the backing Java color. */
    @NotNull
    public Color getColor() {
        return this.color;
    }

    /** Returns the packed color value used by render calls. */
    public int getColorInt() {
        return this.colorInt;
    }

    /** Returns the packed color with its alpha channel replaced. */
    public int getColorIntWithAlpha(float alpha) {
        return RenderingUtils.replaceAlphaInColor(this.colorInt, alpha);
    }

    /** Returns the canonical {@code #RRGGBBAA} representation. */
    @NotNull
    ...
    /** Parses a canonical six- or eight-digit hexadecimal color. */
    @Nullable
    ...
    /** Encodes an AWT color as uppercase {@code #RRGGBBAA}. */
    @Nullable
