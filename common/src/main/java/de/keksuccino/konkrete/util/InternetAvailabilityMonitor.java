...
final class InternetAvailabilityMonitor {
    ...
    void init() {
        ...
        if (initializationFailure != null) {
            LOGGER.error("[KONKRETE] Failed to start the internet availability monitor!", initializationFailure);
        }
    }
    ...
    private void refresh(long scheduledGeneration) {
        ...
        try {
            ...
            LOGGER.error("[KONKRETE] Failed to update the cached internet availability value!", ex);
        }
        ...
        try {
            ...
            LOGGER.error("[KONKRETE] Failed to publish the cached internet availability value!", ex);
        }
    }
    ...
    private void closeProbe() {
        try {
            ...
            LOGGER.error("[KONKRETE] Failed to close the internet availability probe!", ex);
        }
    }
    ...
    private static void cancelTask(@NotNull ScheduledFuture<?> task) {
        try {
            ...
            LOGGER.error("[KONKRETE] Failed to cancel the internet availability refresh task!", ex);
        }
    }
    ...
    private static void shutdownScheduler(@Nullable ScheduledExecutorService scheduler) {
        ...
        try {
            ...
            LOGGER.error("[KONKRETE] Failed to shut down the internet availability scheduler!", ex);
        }
    }
