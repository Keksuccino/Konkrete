...
/** Updates and renders the sunshine visual effect. */
public class SunshineOverlay extends AbstractWidget implements NavigatableWidget {
    ...
    /** Sizes the sunshine effect to the supplied GUI region. */
    public SunshineOverlay(int width, int height) {
        super(0, 0, width, height, Component.empty());
    }

    /** Sets intensity for this sunshine overlay. */
    ...
    /** Sets color for this sunshine overlay. */
    ...
    /** Sets angle for this sunshine overlay. */
    ...
    /** Sets side for this sunshine overlay. */
    ...
    /** Sets focusable for this sunshine overlay. */
    @Override
    ...
    /** Sets navigatable for this sunshine overlay. */
    @Override
