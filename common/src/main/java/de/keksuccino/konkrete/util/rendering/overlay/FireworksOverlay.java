...
/** Updates and renders the fireworks visual effect. */
public class FireworksOverlay extends AbstractWidget implements NavigatableWidget {
    ...
    /** Sizes the fireworks effect to the supplied GUI region. */
    public FireworksOverlay(int width, int height) {
        super(0, 0, width, height, Component.empty());
    }

    /** Sets scale for this fireworks overlay. */
    ...
    /** Sets explosion scale for this fireworks overlay. */
    ...
    /** Returns explosion scale. */
    public float getExplosionScale() {
        return this.explosionScale;
    }

    /** Sets amount multiplier for this fireworks overlay. */
    ...
    /** Sets rocket trail enabled for this fireworks overlay. */
    ...
    /** Sets focusable for this fireworks overlay. */
    @Override
    ...
    /** Sets navigatable for this fireworks overlay. */
    @Override
    ...
    private enum ExplosionShape {
        ...
        RING,
        /** Selects the star option. */
        STAR,
        /** Selects the double ring option. */
        DOUBLE_RING,
        /** Selects the spark burst option. */
        SPARK_BURST,
        /** Selects the fan option. */
        FAN,
        /** Selects the heart option. */
        HEART,
        /** Selects the crackle option. */
        CRACKLE,
        /** Selects the bloom option. */
        BLOOM,
        /** Selects the chrysanthemum option. */
        CHRYSANTHEMUM,
        /** Selects the crown option. */
        CROWN,
        /** Selects the peony option. */
        PEONY,
        /** Selects the willow option. */
        WILLOW,
        /** Selects the palm option. */
        PALM,
        /** Selects the spiral option. */
        SPIRAL,
        /** Selects the pinwheel option. */
        PINWHEEL,
        /** Selects the crossette option. */
        CROSSETTE,
        /** Selects the dahlia option. */
        DAHLIA,
        /** Selects the brocade option. */
        BROCADE,
        /** Selects the sunflower option. */
        SUNFLOWER,
        /** Selects the spider option. */
        SPIDER,
        /** Selects the filled sphere option. */
        FILLED_SPHERE,
        /** Selects the nebula option. */
        NEBULA,
        /** Selects the core cluster option. */
        CORE_CLUSTER,
        /** Selects the super bloom option. */
        SUPER_BLOOM,
        /** Selects the orb option. */
        ORB,
