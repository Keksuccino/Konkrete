...
public class UITooltip implements Renderable {
    ...
    /** Font used to measure and draw tooltip lines. */
    protected Font font = Minecraft.getInstance().font;
    /** Tooltip lines in top-to-bottom order. */
    ...
    /** Text border size in GUI pixels. */
    protected int textBorderSize = 5;
    /** Mouse offset in GUI pixels. */
    protected int mouseOffset = 12;
    /** Horizontal alignment of lines inside the tooltip bounds. */
    ...
    /** Creates a tooltip from literal text lines. */
    @NotNull
    ...
    /** Creates a tooltip from preformatted component lines. */
    @NotNull
    ...
    /** Renders text lines into the active GUI extraction pass. */
    ...
    /** Computes x from the supplied inputs. */
    ...
    /** Computes y from the supplied inputs. */
    ...
    /** Sets tooltip text for this UI tooltip. */
    ...
    /** Sets text border size for this UI tooltip. */
    ...
    /** Returns text border size. */
    public int getTextBorderSize() {
        return this.textBorderSize;
    }

    /** Sets mouse offset for this UI tooltip. */
    ...
    /** Sets text alignment for this UI tooltip. */
    ...
    /** Sets custom x for this UI tooltip. */
    ...
    /** Sets custom y for this UI tooltip. */
