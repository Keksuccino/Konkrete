...
import de.keksuccino.konkrete.util.rendering.ui.screen.texteditor.TextEditorLine;
...
/** Base implementation for highlight brackets formatting rule base. */
public abstract class HighlightBracketsFormattingRuleBase extends TextEditorFormattingRule {

    /** Editor line containing open bracket. */
    protected TextEditorLine openBracketLine = null;
    /** Line-local index of the opening bracket, or {@code -1}. */
    protected int openBracketInLineIndex = -1;
    /** Editor line containing close bracket. */
    protected TextEditorLine closeBracketLine = null;
    /** Line-local index of the closing bracket, or {@code -1}. */
    ...
    /** Returns the Minecraft style produced for the current state. */
    @Override
