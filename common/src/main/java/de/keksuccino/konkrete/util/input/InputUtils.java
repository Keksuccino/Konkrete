...
public class InputUtils {
     ...
     *
     * GLFW key identities cannot be polled for this state on macOS because System Settings can remap physical modifier keys. The event mask already reflects that remapping and is also available while Konkrete handles drag and repeat paths without a new event object.
     */
    public static void updateActiveModifiers(@InputWithModifiers.Modifiers int modifiers) {
        activeModifiers = modifiers;
    }

    /** Resets active modifiers. */
    ...
    /** Returns whether Control is pressed, or Super on macOS. */
