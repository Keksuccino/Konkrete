...
/** Defines the built-in purple void UI color palette. */
public class PurpleVoidUITheme extends UITheme {

    /** Creates an empty purple void UI theme with default state. */
    public PurpleVoidUITheme() {

        super("purple_void", "konkrete.ui.themes.purple_void");
