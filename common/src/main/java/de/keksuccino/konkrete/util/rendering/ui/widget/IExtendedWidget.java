...
/** Provides clipped, scale-aware scrolling-label rendering for extended widgets. */
public interface IExtendedWidget {

    /** Renders a horizontally scrolling label clipped to the supplied widget bounds. */
