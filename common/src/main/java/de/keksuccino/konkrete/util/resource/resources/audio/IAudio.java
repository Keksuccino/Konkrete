...
/** Controls playback and sound-channel routing for a closeable audio resource. */
public interface IAudio extends PlayableResourceWithAudio {
    ...
    /** Assigns the Minecraft sound category controlling effective volume. */
    void setSoundChannel(@NotNull SoundSource channel);

    /** Returns the Minecraft sound category controlling effective volume. */
    @NotNull
