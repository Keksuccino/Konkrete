...
/** Renders smooth circle into Minecraft's deferred GUI pipeline. */
public final class SmoothCircleRenderer {
    ...
    private static final String CIRCLE_INFO_0_NAME_KONKRETE = "CircleInfo0";
    private static final String CIRCLE_INFO_1_NAME_KONKRETE = "CircleInfo1";
    private static final String CIRCLE_INFO_2_NAME_KONKRETE = "CircleInfo2";
    private static final VertexFormat SMOOTH_CIRCLE_VERTEX_FORMAT_KONKRETE = VertexFormat.builder(0)
            ...
            .addAttribute(CIRCLE_INFO_0_NAME_KONKRETE, GpuFormat.RGBA32_FLOAT)
            .addAttribute(CIRCLE_INFO_1_NAME_KONKRETE, GpuFormat.RGBA32_FLOAT)
            .addAttribute(CIRCLE_INFO_2_NAME_KONKRETE, GpuFormat.RGBA32_FLOAT)
            .build();
    private static final VertexFormatElement CIRCLE_INFO_0_KONKRETE = getVertexFormatElement_Konkrete(SMOOTH_CIRCLE_VERTEX_FORMAT_KONKRETE, CIRCLE_INFO_0_NAME_KONKRETE);
    private static final VertexFormatElement CIRCLE_INFO_1_KONKRETE = getVertexFormatElement_Konkrete(SMOOTH_CIRCLE_VERTEX_FORMAT_KONKRETE, CIRCLE_INFO_1_NAME_KONKRETE);
    private static final VertexFormatElement CIRCLE_INFO_2_KONKRETE = getVertexFormatElement_Konkrete(SMOOTH_CIRCLE_VERTEX_FORMAT_KONKRETE, CIRCLE_INFO_2_NAME_KONKRETE);
    private static final RenderPipeline SMOOTH_CIRCLE_PIPELINE_KONKRETE = RenderPipeline.builder().withBindGroupLayout(BindGroupLayouts.GLOBALS)
            .withBindGroupLayout(BindGroupLayouts.MATRICES_PROJECTION)
            .withLocation(Identifier.fromNamespaceAndPath("konkrete", "pipeline/gui_smooth_circle"))
            .withVertexShader(Identifier.fromNamespaceAndPath("konkrete", "core/gui_smooth_circle"))
            .withFragmentShader(Identifier.fromNamespaceAndPath("konkrete", "core/gui_smooth_circle"))
            .withColorTargetState(new ColorTargetState(BlendFunction.TRANSLUCENT))
            .withDepthStencilState(Optional.empty())
            .withVertexBinding(0, SMOOTH_CIRCLE_VERTEX_FORMAT_KONKRETE)
            .withPrimitiveTopology(PrimitiveTopology.QUADS)
            .build();
    private static final float SHAPE_MODE_CIRCLE_KONKRETE = 0.0F;
    private static final float SHAPE_MODE_ARC_KONKRETE = 2.0F;
    ...
    /** Renders smooth circle scaled into the active GUI extraction pass. */
    ...
    /** Renders smooth circle border scaled into the active GUI extraction pass. */
    ...
    private static QuadBounds computeQuadBounds_Konkrete(@Nonnull ArcArea area, float guiScale, float scaledWidth, float scaledHeight, @Nonnull RenderRotationUtil.Rotation2D maskRotation) {
        return computeQuadBounds_Konkrete(new CircleArea(area.x, area.y, area.width, area.height, area.borderThickness, area.roundness, area.color), guiScale, scaledWidth, scaledHeight, maskRotation);
    }
    ...
    private static void submitSmoothCircle_Konkrete(@Nonnull GuiGraphicsExtractor graphics, @Nonnull CircleArea area, @Nonnull QuadBounds bounds, float guiScale, float halfWidth, float halfHeight, float borderThickness, float roundness, @Nonnull RenderRotationUtil.Rotation2D rotation, float shapeMode, float arcStartRadians, float arcEndRadians) {
        ((AccessorMixinGuiGraphicsExtractor)graphics).get_guiRenderState_Konkrete().addGuiElement(new SmoothCircleRenderState(
    ...
    private static void submitSmoothCircle_Konkrete(@Nonnull GuiGraphicsExtractor graphics, @Nonnull ArcArea area, @Nonnull QuadBounds bounds, float guiScale, float halfWidth, float halfHeight, float borderThickness, float roundness, @Nonnull RenderRotationUtil.Rotation2D rotation, float shapeMode, float arcStartRadians, float arcEndRadians) {
        submitSmoothCircle_Konkrete(graphics, new CircleArea(area.x, area.y, area.width, area.height, area.borderThickness, area.roundness, area.color), bounds, guiScale, halfWidth, halfHeight, borderThickness, roundness, rotation, shapeMode, arcStartRadians, arcEndRadians);
    }
    ...
    private record SmoothCircleRenderState(
        ...
        /** Emits the four transformed vertices and custom circle-mask attributes. */
        @Override
        ...
        private void addVertex_Konkrete(@Nonnull VertexConsumer consumer, float x, float y) {
            ...
            writeVec4_Konkrete(consumer, CIRCLE_INFO_0_KONKRETE, this.halfWidth, this.halfHeight, this.borderThickness, this.roundness);
            writeVec4_Konkrete(consumer, CIRCLE_INFO_1_KONKRETE, this.rotation.m00(), this.rotation.m01(), this.rotation.m10(), this.rotation.m11());
            writeVec4_Konkrete(consumer, CIRCLE_INFO_2_KONKRETE, this.shapeMode, this.arcStartRadians, this.arcEndRadians, 0.0F);
        }

        /** Returns the render pipeline used to draw this state. */
        @Override
        public RenderPipeline pipeline() {
            return SMOOTH_CIRCLE_PIPELINE_KONKRETE;
        }
