...
public final class AfmaInspectStandaloneTool {
    ...
    /** Summarizes the sequence for the AFMA creator. */
    @NotNull
    ...
    /** Resolves the payload bytes for the AFMA creator. */
    ...
    /** Prints the sequence summary for the AFMA creator command. */
    ...
    /** Prints the combined summary for the AFMA creator command. */
    ...
    /** Merges the summary for the AFMA creator. */
    ...
    /** Reads the archive summary from the AFMA creator input. */
    @NotNull
    ...
    /** Formats the indexes for AFMA creator diagnostics. */
    @NotNull
    ...
    /** Appends the range to the AFMA creator output state. */
    ...
    /** Models {@code SequenceSummary} state used by the AFMA creator. */
    ...
    /** Models {@code ArchiveSummary} state used by the AFMA creator. */
    protected record ArchiveSummary(@NotNull AfmaFrameIndex frameIndex,
        ...
        /** No cleanup is required because this summary contains only immutable metadata and payload lengths. */
        @Override
        public void close() {
        }
    }
    ...
    protected record Arguments(@Nullable File afmaFile, boolean showIndexes, @Nullable File tempDirectory, boolean help) {
        ...
        /** Requires the value before AFMA creator processing. */
        @NotNull
