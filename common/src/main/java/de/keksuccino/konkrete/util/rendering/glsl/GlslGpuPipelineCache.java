...
final class GlslGpuPipelineCache {
    ...
    private static PipelineBundle createPipeline(@NotNull GlslShaderSourceTransformer.FragmentVariant variant, @NotNull GpuFormat targetFormat, boolean blend) {
        ...
        Identifier vertexId = Identifier.fromNamespaceAndPath("konkrete", "runtime_glsl/vertex/" + variant.identity());
        Identifier fragmentId = Identifier.fromNamespaceAndPath("konkrete", "runtime_glsl/fragment/" + variant.identity());
        Identifier pipelineId = Identifier.fromNamespaceAndPath("konkrete", "runtime_glsl/pipeline/" + pipelineIdentity);
