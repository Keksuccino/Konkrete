package de.keksuccino.konkrete.util.rendering.overlay;
...
/** Updates and renders the string lights visual effect. */
public class StringLightsOverlay extends AbstractWidget implements NavigatableWidget {
    ...
    /** Sizes the hanging string-light effect to the supplied GUI region. */
    public StringLightsOverlay(int width, int height) {
        super(0, 0, width, height, Component.empty());
    }

    /** Sets scale for this string lights overlay. */
    ...
    /** Sets wind strength for this string lights overlay. */
    ...
    /** Sets flicker speed for this string lights overlay. */
    ...
    /** Sets color for this string lights overlay. */
    ...
    /** Sets christmas mode for this string lights overlay. */
    public void setChristmasMode(boolean christmasMode) {
        this.christmasMode = christmasMode;
    }

    /** Returns whether christmas mode. */
    public boolean isChristmasMode() {
        return this.christmasMode;
    }

    /** Sets position christmas mode for this string lights overlay. */
    ...
    /** Returns whether position enabled. */
    ...
    /** Sets position color for this string lights overlay. */
    ...
    /** Sets focusable for this string lights overlay. */
    @Override
    ...
    /** Sets navigatable for this string lights overlay. */
    @Override
