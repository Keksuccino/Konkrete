...
/** Renders smooth image rectangle into Minecraft's deferred GUI pipeline. */
public final class SmoothImageRectangleRenderer {
    ...
    private static final String IMAGE_RECT_INFO_0_NAME_KONKRETE = "ImageRectInfo0";
    private static final String IMAGE_RECT_INFO_1_NAME_KONKRETE = "ImageRectInfo1";
    private static final String IMAGE_RECT_INFO_2_NAME_KONKRETE = "ImageRectInfo2";
    private static final String IMAGE_RECT_INFO_3_NAME_KONKRETE = "ImageRectInfo3";
    private static final VertexFormat SMOOTH_IMAGE_RECT_VERTEX_FORMAT_KONKRETE = VertexFormat.builder(0)
            ...
            .addAttribute(IMAGE_RECT_INFO_0_NAME_KONKRETE, GpuFormat.RGBA32_FLOAT)
            .addAttribute(IMAGE_RECT_INFO_1_NAME_KONKRETE, GpuFormat.RGBA32_FLOAT)
            .addAttribute(IMAGE_RECT_INFO_2_NAME_KONKRETE, GpuFormat.RGBA32_FLOAT)
            .addAttribute(IMAGE_RECT_INFO_3_NAME_KONKRETE, GpuFormat.RGBA32_FLOAT)
            .build();
    private static final VertexFormatElement IMAGE_RECT_INFO_0_KONKRETE = getVertexFormatElement_Konkrete(SMOOTH_IMAGE_RECT_VERTEX_FORMAT_KONKRETE, IMAGE_RECT_INFO_0_NAME_KONKRETE);
    private static final VertexFormatElement IMAGE_RECT_INFO_1_KONKRETE = getVertexFormatElement_Konkrete(SMOOTH_IMAGE_RECT_VERTEX_FORMAT_KONKRETE, IMAGE_RECT_INFO_1_NAME_KONKRETE);
    private static final VertexFormatElement IMAGE_RECT_INFO_2_KONKRETE = getVertexFormatElement_Konkrete(SMOOTH_IMAGE_RECT_VERTEX_FORMAT_KONKRETE, IMAGE_RECT_INFO_2_NAME_KONKRETE);
    private static final VertexFormatElement IMAGE_RECT_INFO_3_KONKRETE = getVertexFormatElement_Konkrete(SMOOTH_IMAGE_RECT_VERTEX_FORMAT_KONKRETE, IMAGE_RECT_INFO_3_NAME_KONKRETE);
    private static final RenderPipeline SMOOTH_IMAGE_RECT_PIPELINE_KONKRETE = RenderPipeline.builder().withBindGroupLayout(BindGroupLayouts.GLOBALS)
            .withBindGroupLayout(BindGroupLayouts.MATRICES_PROJECTION)
            .withBindGroupLayout(BindGroupLayouts.SAMPLER0)
            .withLocation(Identifier.fromNamespaceAndPath("konkrete", "pipeline/gui_smooth_image_rect"))
            .withVertexShader(Identifier.fromNamespaceAndPath("konkrete", "core/gui_smooth_image_rect"))
            .withFragmentShader(Identifier.fromNamespaceAndPath("konkrete", "core/gui_smooth_image_rect"))
            .withColorTargetState(new ColorTargetState(BlendFunction.TRANSLUCENT))
            .withDepthStencilState(Optional.empty())
            .withVertexBinding(0, SMOOTH_IMAGE_RECT_VERTEX_FORMAT_KONKRETE)
    ...
    /** Renders smooth image rect into the active GUI extraction pass. */
    ...
    /** Renders smooth image rect scaled into the active GUI extraction pass. */
    ...
    /** Renders smooth image rect round top corners into the active GUI extraction pass. */
    ...
    /** Renders smooth image rect round top corners scaled into the active GUI extraction pass. */
    ...
    /** Renders smooth image rect round bottom corners into the active GUI extraction pass. */
    ...
    /** Renders smooth image rect round bottom corners scaled into the active GUI extraction pass. */
    ...
    /** Renders smooth image rect round all corners into the active GUI extraction pass. */
    ...
    /** Renders smooth image rect round all corners scaled into the active GUI extraction pass. */
    ...
    private static void _renderSmoothImageRect(@Nonnull GuiGraphicsExtractor graphics, @Nonnull RectArea area) {
        ...
        submitSmoothImageRect_Konkrete(graphics, area, texture, bounds, guiScale, scaledWidth * 0.5F, scaledHeight * 0.5F, scaledRadii, rotation);
    ...
    private static void submitSmoothImageRect_Konkrete(@Nonnull GuiGraphicsExtractor graphics, @Nonnull RectArea area, @Nonnull AbstractTexture texture, @Nonnull QuadBounds bounds, float guiScale, float halfWidth, float halfHeight, @Nonnull CornerRadii cornerRadii, @Nonnull RenderRotationUtil.Rotation2D rotation) {
        ((AccessorMixinGuiGraphicsExtractor)graphics).get_guiRenderState_Konkrete().addGuiElement(new SmoothImageRectRenderState(
    ...
    private record SmoothImageRectRenderState(
        ...
        /** Emits the textured quad with rounded-corner, rotation, and UV attributes. */
        @Override
        ...
        private void addVertex_Konkrete(@Nonnull VertexConsumer consumer, float x, float y) {
            ...
            writeVec4_Konkrete(consumer, IMAGE_RECT_INFO_0_KONKRETE, this.halfWidth, this.halfHeight, 0.0F, 0.0F);
            writeVec4_Konkrete(consumer, IMAGE_RECT_INFO_1_KONKRETE, this.cornerRadii.topLeft(), this.cornerRadii.topRight(), this.cornerRadii.bottomRight(), this.cornerRadii.bottomLeft());
            writeVec4_Konkrete(consumer, IMAGE_RECT_INFO_2_KONKRETE, this.rotation.m00(), this.rotation.m01(), this.rotation.m10(), this.rotation.m11());
            writeVec4_Konkrete(consumer, IMAGE_RECT_INFO_3_KONKRETE, this.textureRegion.minU(), this.textureRegion.minV(), this.textureRegion.maxU(), this.textureRegion.maxV());
        }

        /** Returns the render pipeline used to draw this state. */
        @Override
        public RenderPipeline pipeline() {
            return SMOOTH_IMAGE_RECT_PIPELINE_KONKRETE;
        }
