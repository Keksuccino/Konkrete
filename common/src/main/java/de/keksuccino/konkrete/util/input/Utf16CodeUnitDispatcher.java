...
public final class Utf16CodeUnitDispatcher {
    ...
    /**
     * Delivers each UTF-16 unit for {@code codePoint} in order and returns whether either unit was handled.
     *
     * @throws IllegalArgumentException when {@code codePoint} is outside the Unicode range
    ...
    /** Receives UTF-16 code units produced from one Unicode code point. */
    @FunctionalInterface
    public interface Handler {

        /** Handles one UTF-16 code unit with the original modifier mask. */
