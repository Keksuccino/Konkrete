...
import de.keksuccino.konkrete.util.OSUtils;
...
/** Utility methods for dot minecraft. */
public class DotMinecraftUtils {
    ...
    public static Path getMinecraftDirectory() {
        ...
        if (OSUtils.isWindows()) {
            ...
            if (appData != null) {
                ...
                LOGGER.warn("[KONKRETE] Failed to resolve user home directory.");
    ...
    /** Returns the minecraft directory as file. */
    @NotNull
