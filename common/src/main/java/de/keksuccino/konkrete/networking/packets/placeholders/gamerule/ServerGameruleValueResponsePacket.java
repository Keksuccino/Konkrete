...
/** Returns one gamerule value for a correlated client request. */
public final class ServerGameruleValueResponsePacket extends Packet {
    ...
    /**
     * Creates a correlated gamerule response.
     *
     * @param requestId matching positive client correlation ID
     * @param value resolved value, or {@code null} when unavailable
     */
    public ServerGameruleValueResponsePacket(long requestId, @Nullable String value) {
     ...
     *
     * @return value, or {@code null} when unavailable
     */
    ...
    public boolean processClientPacket(@NotNull Connection connection) {
        return ServerPlaceholderRequests.handleGameruleResponse(connection, this.requestId, this.value);
    }
