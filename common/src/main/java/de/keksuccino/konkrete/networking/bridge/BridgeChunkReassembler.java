...
public final class BridgeChunkReassembler {
    ...
    /** Maximum concurrent transfers reserved by one exact connection. */
    public static final int MAX_IN_FLIGHT_PER_SESSION = 4;
    /** Maximum declared bytes reserved by one exact connection. */
    public static final long MAX_RESERVED_BYTES_PER_SESSION = 16L * 1024L * 1024L;
    /** Maximum declared bytes reserved across all exact connections. */
    public static final long MAX_RESERVED_BYTES_GLOBAL = 64L * 1024L * 1024L;
    /** Inactivity timeout for transfers and terminated transfer IDs. */
    ...
    /**
     * Creates a reassembler using the monotonic system clock.
     */
    ...
    /**
     * Replaces the exact client session and releases the old session's reservations.
     *
     * @param connection new client connection identity
     */
    ...
    /**
     * Opens one exact server connection owned by an exact server identity.
     *
     * @param server owning server identity
     * @param connection connection identity
     */
    ...
    /**
     * Ends one exact session and releases all reservations.
     *
     * @param connection connection identity, or {@code null}
     */
    ...
    /**
     * Ends every connection owned by one exact server.
     *
    ...
    /**
     * Accepts one validated chunk for an active exact connection.
     *
     * @param connection connection identity
     * @param payload decoded chunk
     * @return incomplete, complete, or rejected result
     */
    ...
    /**
     * Expires all currently stale transfers immediately.
     */
    ...
    /**
     * Reassembly result and optional complete message.
     *
     * @param status result status
     * @param message complete decoded message only for {@link Status#COMPLETE}
     */
