...
public final class BridgeProtocol {
    ...
    /** Current binary chunk protocol version. */
    public static final int VERSION = 1;
    /** Largest UTF-8 message carried by the compatibility payload. */
    public static final int MAX_LEGACY_MESSAGE_BYTES = 30 * 1024;
    /** Largest binary data section in one chunk. */
    public static final int MAX_CHUNK_DATA_BYTES = 30 * 1024;
    /** Largest reassembled UTF-8 logical envelope. */
    public static final int MAX_LOGICAL_MESSAGE_BYTES = 8 * 1024 * 1024;
    /** Largest compatibility direction marker. */
    public static final int MAX_LEGACY_DIRECTION_BYTES = 32;
    /** Vanilla-safe upper bound for one registered payload body. */
