...
/** Exposes the current Java virtual machine implementation name. */
public class JvmNamePlaceholder extends Placeholder {

    /** Creates the {@code jvmname} placeholder. */
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("konkrete.placeholders.jvm_name");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(LocalizationUtils.splitLocalizedStringLines("konkrete.placeholders.jvm_name.desc"));
    }
