...
/** Applies the replace text transformation for {@code replace_text}. */
public class ReplaceTextPlaceholder extends Placeholder {

    private static final Logger LOGGER = LogManager.getLogger();

    /** Creates the {@code replace_text} placeholder. */
    ...
    public String getReplacementFor(DeserializedPlaceholderString dps) {
        ...
        try {
            ...
            LOGGER.error("[KONKRETE] Invalid regex pattern in 'Replace Text' placeholder: " + search, e);
            return text;
        } catch (Exception e) {
            LOGGER.error("[KONKRETE] Error in 'Replace Text' placeholder: " + dps.placeholderString, e);
            return text;
        }
    }
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("konkrete.placeholders.replace_text");
    }

    @Override
    public @Nullable List<String> getDescription() {
        return List.of(LocalizationUtils.splitLocalizedStringLines("konkrete.placeholders.replace_text.desc"));
    }
    ...
    public @NotNull DeserializedPlaceholderString getDefaultPlaceholderString() {
        ...
        values.put("replacement", "Konkrete");
