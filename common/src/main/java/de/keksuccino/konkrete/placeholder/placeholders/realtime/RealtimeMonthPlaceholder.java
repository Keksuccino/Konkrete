...
/** Formats wall-clock realtime month for {@code realtimemonth}. */
public class RealtimeMonthPlaceholder extends AbstractRealtimePlaceholder {

    /** Creates the {@code realtimemonth} placeholder. */
    ...
    public String getReplacementFor(DeserializedPlaceholderString dps) {
        ...
        return formatTwoDigitDateTimePart(c.get(Calendar.MONTH) + 1);
    }
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("konkrete.placeholders.realtime_month");
    }
