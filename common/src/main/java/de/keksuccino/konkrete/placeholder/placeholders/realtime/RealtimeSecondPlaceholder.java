...
/** Formats wall-clock realtime second for {@code realtimesecond}. */
public class RealtimeSecondPlaceholder extends AbstractRealtimePlaceholder {

    /** Creates the {@code realtimesecond} placeholder. */
    ...
    public String getReplacementFor(DeserializedPlaceholderString dps) {
        ...
        return formatTwoDigitDateTimePart(c.get(Calendar.SECOND));
    }
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("konkrete.placeholders.realtime_second");
    }
