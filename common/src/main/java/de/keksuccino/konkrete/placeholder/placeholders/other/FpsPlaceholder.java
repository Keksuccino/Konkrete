...
/** Exposes Minecraft's latest rendered frames-per-second sample. */
public class FpsPlaceholder extends Placeholder {

    /** Creates the {@code fps} placeholder. */
    public FpsPlaceholder() {
        super("fps");
    }

    /** Render-loop state is sampled only on the Minecraft client thread. */
    @Override
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("konkrete.placeholders.fps");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(LocalizationUtils.splitLocalizedStringLines("konkrete.placeholders.fps.desc"));
    }
