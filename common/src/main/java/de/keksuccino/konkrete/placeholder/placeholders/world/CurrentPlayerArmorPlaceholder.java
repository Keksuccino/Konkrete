...
/** Reads current player armor state from the current vanilla world/player for {@code current_player_armor}. */
public class CurrentPlayerArmorPlaceholder extends AbstractWorldFloatPlaceholder {

    /** Creates the {@code current_player_armor} placeholder. */
    ...
    protected @NotNull String getLocalizationBase() {
        return "konkrete.placeholders.world.current_player_armor";
    }
