...
/** Exposes the active render device's OpenGL version string. */
public class OpenGLVersionPlaceholder extends Placeholder {

    /** Creates the {@code glver} placeholder. */
    ...
    public @NotNull String getDisplayName() {
        return I18n.get("konkrete.placeholders.opengl_version");
    }

    @Override
    public List<String> getDescription() {
        return Arrays.asList(LocalizationUtils.splitLocalizedStringLines("konkrete.placeholders.opengl_version.desc"));
    }
