package de.keksuccino.persephone.input;

import de.keksuccino.persephone.mixin.mixins.common.client.AccessorMixinMouseHandler;
...
public class MouseInput {
	...
	public static int getActiveMouseButton() {
		return ((AccessorMixinMouseHandler)Minecraft.getInstance().mouseHandler).get_lastClickButton_Persephone();
	}
